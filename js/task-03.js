...
const markup = images.map(image =>
  `<li class="js-galleryItem">
  <img class="js-galleryItemImg" src=${image.url} alt='${image.alt}' width="320" height="200" />
  </li>`)
  .join('');
...
const img = document.querySelectorAll(".js-galleryItemImg");
